<div class="group relative aspect-[4/3] overflow-hidden rounded-sm motion-card motion-border-card reveal reveal-up" data-animate>
    <img src="{{ asset($project['image']) }}" alt="{{ $project['title'] }}" loading="lazy" width="400" height="300" class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110 motion-image">
